...
if __name__ == "__main__":
    ...
    pygame.display.set_caption('Flappy Bird by Pranav')
    ...
    GAME_SPRITES['message'] = pygame.image.load(
        'gallery/sprites/background1.jpeg').convert_alpha()
    GAME_SPRITES['base'] = pygame.image.load(
        'gallery/sprites/ground.png').convert_alpha()
    ...
    GAME_SOUNDS['point'] = pygame.mixer.Sound(
        'gallery/audio/Cartoon_Boing.wav')
    GAME_SOUNDS['swoosh'] = pygame.mixer.Sound('gallery/audio/swoosh.wav')
    GAME_SOUNDS['wing'] = pygame.mixer.Sound('gallery/audio/fly.wav')
